                ...
                <div className="flex flex-row gap-8 p-6 bg-gray-100 rounded-xl shadow-lg">
                    <div className="flex bg-white rounded-xl p-4 shadow-md w-60 border border-gray-200">
                        <div className="flex flex-col gap-2">
                            ...
                            <p className="text-gray-700 font-semibold">Puntaje: <span className="font-normal">{jugador1.Datos.puntaje}</span></p>
                    ...
                    <div className="flex bg-white rounded-xl p-4 shadow-md w-60 border border-gray-200">
                        <div className="flex flex-col gap-2">
                            ...
                            <p className="text-gray-700 font-semibold">Puntaje: <span className="font-normal">{jugador2.Datos.puntaje}</span></p>
...
{/* 
                ...
                <button className={`rounded-xl p-4 text-white bg-blue-500 m-8`} onClick={() => TerminarTodo()}>Terminar Juego</button>
