        ...
        <main>
            <div className="w-full flex flex-col h-screen justify-center text-black">
                <aside className={` ${points ? 'hidden' : 'block'}`}>
                      <div className=" m-4 rounded-3xl border-2 border-gray-300 shadow-lg animate__animated animate__fadeIn">
                ...
                <div id='containerDistribution' className={` m-4 rounded-3xl border-2 border-gray-300 shadow-lg flex flex-col items-center p-4 gap-7 ${points ? 'h-screen' : ""}`}>
